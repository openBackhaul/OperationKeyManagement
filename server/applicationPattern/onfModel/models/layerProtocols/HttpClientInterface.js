 ...
 **/
 ...
 const applicationNameAttributePath = "/core-model-1-4:control-construct/logical-termination-point={uuid}/layer-protocol=0/http-client-interface-1-0:http-client-interface-pac/http-client-interface-capability/application-name";
 ...
 class HttpClientInterface extends layerProtocol {
     ...
     /**
      * @description This function sets the application name for the http client uuid<br>
      * @param {String} httpClientUuid uuid of the http-client-interface <br>
      * @param {String} newApplicationName applcation name of the http-client-interface <br>
      * @returns {promise} returns true if the value is set<br>
      * <b><u>Procedure :</u></b><br>
      * <b>step 1 :</b> formulate the path to point to the application-name for the provided logical-termination-point<br>
      * <b>step 2 :</b> set the application name<br>
      **/
    static setApplicationName(httpClientUuid, newApplicationName) {
        return new Promise(async function (resolve, reject) {
            let isUpdated = false;
            try {
                let setApplicationNamePath = applicationNameAttributePath.replace("{uuid}", httpClientUuid);
                isUpdated = await fileOperation.writeToDatabase(setApplicationNamePath, newApplicationName, false);
                resolve(isUpdated);
            } catch (error) {
                resolve(isUpdated);
            }
